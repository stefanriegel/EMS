...
from backend.coordinator_ha_commands import HaCommandsMixin
...
class Coordinator(HaCommandsMixin):
    ...
    # HA command handling: see coordinator_ha_commands.HaCommandsMixin
