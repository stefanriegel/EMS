...
- [x] **HWVAL-04**: EMS runs 48h read-only validation phase before enabling writes on each battery system
...
- [x] **XCHG-04**: First detection per episode triggers Telegram alert
- [x] **XCHG-05**: Cumulative cross-charge waste energy tracked in InfluxDB
...
| XCHG-04 | Phase 21 | Complete |
| XCHG-05 | Phase 21 | Complete |
