...
- [x] 06-02-PLAN.md — Backend wizard migration: EmsSetupConfig + Modbus TCP probe + VictronConfig forward compat
- [x] 06-03-PLAN.md — Frontend wizard: Modbus TCP Step 2 + Modul3 Step 5 + CSS classes + E2E tests
